...
export default {
  ...
  methods: {
    handleSubmit() {
      alert("Searching for destinations!");
    },
  },
};
</script>
...
<template>
  ...
  <section class="destinations p-140">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="destination-card">
            <img src="../assets/boxes/2.png" alt="Saintmartine Iceland" />
            <div class="price-tag">$500</div>
            <div class="info">
              <h5>Saintmartine Iceland</h5>
              <p>United States of America</p>
        ...
        <div class="col-md-4">
          <div class="destination-card">
            <img src="../assets/boxes/3.png" alt="Saintmartine Iceland" />
            <div class="price-tag">$500</div>
            <div class="info">
              <h5>Saintmartine Iceland</h5>
              <p>United States of America</p>
        ...
        <div class="col-md-4">
          <div class="destination-card">
            <img src="../assets/boxes/4.png" alt="Saintmartine Iceland" />
            <div class="price-tag">$500</div>
            <div class="info">
              <h5>Saintmartine Iceland</h5>
              <p>United States of America</p>
        ...
        <div class="col-md-4">
          <div class="destination-card">
            <img src="../assets/boxes/5.png" alt="Saintmartine Iceland" />
            <div class="price-tag">$500</div>
            <div class="info">
              <h5>Saintmartine Iceland</h5>
              <p>United States of America</p>
        ...
        <div class="col-md-4">
          <div class="destination-card">
            <img src="../assets/boxes/6.png" alt="Saintmartine Iceland" />
            <div class="price-tag">$500</div>
            <div class="info">
              <h5>Saintmartine Iceland</h5>
              <p>United States of America</p>
